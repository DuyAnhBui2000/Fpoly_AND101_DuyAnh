...
public class AdapterUngDung extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvMuc4 = convertView.findViewById(R.id.tvMuc4);
...
//        });
    ...
    private void showCapNhatDialog(final UngDung app) {
        ...
        final EditText etMuc4CapNhap = dialog.findViewById(R.id.etMuc4CapNhap);
        ...
        etMuc4CapNhap.setText(app.getMuc4());
        ...
        btnCapNhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String muc4 = etMuc4CapNhap.getText().toString();
